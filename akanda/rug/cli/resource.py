...
class _TenantResourceCmd(message.MessageSending):
    ...
    def make_message(self, parsed_args):
        ...
        self.log.info(
            'sending %s instruction for tenant %r, resource %r',
            self._COMMAND,
            tenant_id,
            resource_id,
        )
...
class ResourceRebuild(_TenantResourceCmd):
    ...
    def take_action(self, parsed_args):
        uuid = parsed_args.resource_image_uuid
        if uuid:
    ...
    def make_message(self, parsed_args):
        ...
        message['resource_image_uuid'] = parsed_args.resource_image_uuid
        return message

...
# XXX this should all be moved to router driver's unit tests
...
#        self.assertEqual(1, log_debug.call_count)
    ...
    @mock.patch('akanda.rug.api.neutron.Neutron')
    def test_scheduler_handle_message(self, mocked_neutron_api, event, enabled_drivers):
        enabled_drivers.return_value = [FakePopulateDriver]

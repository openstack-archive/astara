...
class TestInstanceManager(unittest.TestCase):
    ...
    def test_update_state_is_alive(self, router_api):
        ...
        self.assertEqual(self.instance_mgr.update_state(self.ctx), instance_manager.UP)
    ...
    def test_boot_timeout(self, router_api, sleep):
        ...
        self.assertEqual(self.instance_mgr.update_state(self.ctx), instance_manager.DOWN)
        router_api.is_alive.assert_has_calls([
            mock.call(self.INSTANCE_INFO.management_address, 5000),
            mock.call(self.INSTANCE_INFO.management_address, 5000),
            mock.call(self.INSTANCE_INFO.management_address, 5000),
    ...
    def test_boot_success(self, sleep):
        ...
        self.assertEqual(self.instance_mgr.state, instance_manager.BOOTING)  # async
    ...
    def test_configure_success(self, config, router_api):
        ...
        with mock.patch.object(self.instance_mgr, '_verify_interfaces') as verify:
            verify.return_value = True
            self.instance_mgr.configure(self.ctx)
            ...
            self.assertEqual(self.instance_mgr.state, instance_manager.CONFIGURED)

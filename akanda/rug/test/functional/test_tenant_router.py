...
class TestAkandaRouter(base.AkandaFunctionalBase):
    ...
    def test_get_router_by_creating_a_net(self):
        ...
        # first config update nad health checks get queued up behind the
        # hanging config update.  If thats the case, we need to wait a while
        # after deletion for the first to timeout, the subsequent to pass
        # and the health check to fire.
        time.sleep(120)

...
3 routing and advanced networking services.  Astara, Inc provides stable image
...
repository at ``https://github.com/openstack/astara-appliance``.  Additional tooling
...
::
    ...
    git clone https://github.com/stackforge/astara-appliance

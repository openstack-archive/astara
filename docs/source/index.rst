...
Astara is an open source network virtualization platform built by
...
`DreamCompute <https://dreamhost.com/compute/cloud>`_, Astara eliminates the
...
Licensing
---------
Astara is licensed under the Apache-2.0 license and is copyright `Astara, Inc
<http://akanda.io>`_.

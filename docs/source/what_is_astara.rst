...
most important of those building blocks, the Astara Orchistrator, is a
...
From an architectural perspective, Astara is composed of a few sub-projects:
    ...
    * | :ref:`Astara Orchistrator <http://github.com/openstack/astara>`

      A service for managing the creation, configuration, and health of Astara
      Service Instances.  The orchistrator acts in part as a replacement for
      ...
      orchistrator contains a health monitoring component which monitors health
...
a floating IP address is associated, etc...), Astara Orchistrator receives these

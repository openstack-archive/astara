...
class TestTenantResourceManager(base.RugTestBase):
    ...
    def setUp(self):
        ...
        self.load_driver_p = mock.patch(
            'astara.tenant.TenantResourceManager._load_driver_from_message')
        self.fake_load_driver = self.load_driver_p.start()
        self.fake_load_driver.return_value = self.fake_driver
    ...
    def test__load_driver_from_message_no_byonf(self, fake_get, fake_byonf):
        ...
        self.assertEqual(
            self.trm._load_driver_from_message(self.ctx, msg),
            'fake_driver')
    ...
    def test__load_driver_from_message_with_byonf(self, fake_get, fake_byonf):
        ...
        self.assertEqual(
            self.trm._load_driver_from_message(self.ctx, msg), fake_driver)

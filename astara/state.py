...
from astara.event import POLL, CREATE, READ, UPDATE, DELETE, REBUILD, CLUSTER_REBUILD
...
class CalcAction(State):
    def execute(self, action, worker_context):
        ...
        while queue:
            ...
            elif action in (CREATE, UPDATE, CLUSTER_REBUILD) and queue[0] == REBUILD:
    ...
    def transition(self, action, worker_context):
        ...
        elif action == CLUSTER_REBUILD and self.instance.state in (states.DEGRADED, states.DOWN):

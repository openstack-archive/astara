...
AKANDA_NEUTRON_REPO=${AKANDA_NEUTRON_REPO:-${GIT_BASE}/openstack/akanda-neutron.git}
AKANDA_NEUTRON_BRANCH=${AKANDA_NEUTRON_BRANCH:-master}

AKANDA_APPLIANCE_DIR=${AKANDA_APPLIANCE_DIR:-$DEST/akanda-appliance}
AKANDA_APPLIANCE_REPO=${AKANDA_APPLIANCE_REPO:-${GIT_BASE}/openstack/akanda-appliance.git}
...
AKANDA_HORIZON_REPO=${AKANDA_HORIZON_REPO:-${GIT_BASE}/openstack/akanda-horizon}

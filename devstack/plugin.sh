...
AKANDA_NEUTRON_BRANCH=${AKANDA_NEUTRON_BRANCH:-stable/liberty}
...
AKANDA_APPLIANCE_BRANCH=${AKANDA_APPLIANCE_BRANCH:-stable/liberty}
...
AKANDA_HORIZON_BRANCH=${AKANDA_HORIZON_BRANCH:-stable/liberty}
...
function start_akanda_rug() {
    ...
    screen_it $svc "cd $AKANDA_RUG_DIR && akanda-rug-service --config-file $AKANDA_RUG_CONF"
    echo '************************************************************'

...
ROUTER_INSTANCE_FLAVOR_ID=135  # NOTE(adam_g): This can be auto-generated UUID once RUG supports non-int IDs here
ROUTER_INSTANCE_FLAVOR_RAM=512
ROUTER_INSTANCE_FLAVOR_DISK=5
ROUTER_INSTANCE_FLAVOR_CPUS=1
